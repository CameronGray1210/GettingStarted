...
1. clone your forked repo to your local machine, `git clone https://github.com/{your username}/GettingStarted`
...
8. Save image to the `/static/img` folder in the `GettingStarted` repo
